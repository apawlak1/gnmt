...
# ======================================================================
# URUCHOMIENIE NA POJEDYNCZYM PLIKU - podmien te dwie sciezki i odpal
# ======================================================================
if __name__ == '__main__':
    #---PODMIEN NA WLASNE SCIEZKI---
    input_path=r'C:\Users\strze\Downloads\73210_980638_N-34-111-A-b-3-1_asc\NMT-N34111Ab31_p.asc'
    output_path=r'C:\Users\strze\Downloads\73210_980638_N-34-111-A-b-3-1_asc\lol.tif'

    wynik=ASCII2GT(input_path, output_path)

    if wynik is None:
        print('[KONWERTER ASCII] Konwersja nie powiodla sie (patrz komunikaty powyzej).')
    else:
        cellsize, raster=wynik
        print(f'\n[KONWERTER ASCII] Gotowe. cellsize={cellsize} m, '
              f'wymiary rastra={raster.shape}')